 ...
 */
// [[Rcpp::export]]
double scr_nll_cuerate(const NumericVector& pars,
		       const arma::mat& caps,
		       const double& aMask,
  ...
  arma::vec n_indiv_calls(nAnimals);
  n_indiv_calls.zeros();
 ...
 */
// [[Rcpp::export]]
NumericMatrix eucdist(const NumericMatrix& points,
		      const NumericMatrix& traplocations) {
